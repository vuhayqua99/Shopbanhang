...
public class ContactController {
	...
	public String submitContact(HttpServletRequest request, @RequestParam("attachment") MultipartFile multipartFile)
		...
		helper.setFrom("nguyentrongvu121199@gmail.com", "Shop Jewery");
		helper.setTo("nguyentuananh12042007@gmail.com");
		helper.setSubject(mailSubject);
		helper.setText(mailContent, true);

		ClassPathResource resource = new ClassPathResource("/static/assets/user/img/logo-bootstrap-shoping-cart.png");
